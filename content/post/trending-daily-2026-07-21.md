...
{{< raw >}}
	<main class="container">
      ...
      Local-first code intelligence graph for MCP and CLI. Builds a persistent map of your codebase so AI coding tools read only what matters, with benchmarked context reductions on reviews and large-repo workflows.
				...
				<div class="stars-today">⭐ 1833 stars today</div>
				</div>
			</div>
      ...
      Learn it. Build it. Ship it for others.
				...
				<div class="stars-today">⭐ 823 stars today</div>
				</div>
			</div>
      ...
      AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨
			...
			<div class="repo-card">
				<p><a href="https://github.com/PrefectHQ/fastmcp" target="_blank">
      ...
      Self-hosted deployment platform
				...
				<div class="stars-today">⭐ 1641 stars today</div>
				</div>
			</div>
	
			<div class="repo-card">
				<p><a href="https://github.com/microsoft/Ontology-Playground" target="_blank">
      ...
      Free, open-source web app for learning about ontologies and Microsoft Fabric IQ. Explore a catalogue of pre-built ontologies, design your own visually, export as RDF/XML, and share interactive diagrams. Zero backend, fully static.
			...
			<div class="repo-card">
				<p><a href="https://github.com/handy-computer/transcribe.cpp" target="_blank">
