...
{{< raw >}}
	<main class="container">
      ...
      所有小初高、大学PDF教材。
				...
				<div class="stars-today">⭐ 21903 stars this week</div>
				</div>
			</div>
      ...
      🚀 One-stop solution for creating your digital avatar from chat logs 💡 Fine-tune LLMs with your chat logs to capture your unique style, then bind to a chatbot to bring your digital self to life. 从聊天记录创造数字分身的一站式解决方案 
				...
				<div class="stars-today">⭐ 5753 stars this week</div>
				</div>
			</div>
      ...
      This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
				...
				<div class="stars-today">⭐ 1355 stars this week</div>
				</div>
			</div>
      ...
      Neon: Serverless Postgres. We separated storage and compute to offer autoscaling, code-like database branching, and scale to zero.
				...
				<div class="stars-today">⭐ 913 stars this week</div>
				</div>
			</div>
