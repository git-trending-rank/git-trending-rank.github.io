---
title: GitHub 趋势 2026-07-11
date: 2026-07-11T10:46:38Z
categories:
- daily
keywords:
- git trending
...
{{< raw >}}
	<main class="container">
      ...
      Production-grade engineering skills for AI coding agents.
			...
			<div class="repo-card">
				<p><a href="https://github.com/jbeder/yaml-cpp" target="_blank">
      ...
      Skills for Real Engineers. Straight from my .claude directory.
				...
				<div class="stars-today">⭐ 1712 stars today</div>
				</div>
			</div>
      ...
      An agentic skills framework & software development methodology that works.
				...
				<div class="stars-today">⭐ 1013 stars today</div>
				</div>
			</div>
      ...
      Mesh optimization library that makes meshes smaller and faster to render
			...
			<div class="repo-card">
				<p><a href="https://github.com/tailscale/tailscale" target="_blank">
      ...
      OfficeCLI is the first and best Office suite purpose-built for AI agents to read, edit, and automate Word, Excel, and PowerPoint files. Free, open-source, single binary, no Office installation required.
				...
				<div class="stars-today">⭐ 1224 stars today</div>
				</div>
			</div>
      ...
      Terraform enables you to safely and predictably create, change, and improve infrastructure. It is a source-available tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
			...
			<div class="repo-card">
				<p><a href="https://github.com/grpc/grpc" target="_blank">
