...
{{< raw >}}
	<main class="container">
      ...
      Open-source AI agents for penetration testing
				...
				<div class="stars-today">⭐ 7867 stars this week</div>
				</div>
			</div>
      ...
      微舆：人人可用的多Agent舆情分析助手，打破信息茧房，还原舆情原貌，预测未来走向，辅助决策！从0实现，不依赖任何框架。
				...
				<div class="stars-today">⭐ 9485 stars this week</div>
				</div>
			</div>
      ...
      🎯 告别信息过载，AI 助你看懂新闻资讯热点，简单的舆情监控分析 - 多平台热点聚合+基于 MCP 的AI分析工具。监控35个平台（抖音、知乎、B站、华尔街见闻、财联社等），智能筛选+自动推送+AI对话分析（用自然语言深度挖掘新闻：趋势追踪、情感分析、相似检索等13种工具）。支持企业微信/飞书/钉钉/Telegram/邮件/ntfy推送，30秒网页部署，1分钟手机通知，无需编程。支持Docker部署⭐ 让算法为你服务，用AI理解热点
				...
				<div class="stars-today">⭐ 5444 stars this week</div>
				</div>
			</div>
      ...
      A lightweight, secure, and feature-rich Discord terminal (TUI) client.
				...
				<div class="stars-today">⭐ 146 stars this week</div>
				</div>
			</div>
      ...
      Docker container for managing Nginx proxy hosts with a simple, powerful interface
				...
				<div class="stars-today">⭐ 313 stars this week</div>
				</div>
			</div>
      ...
      An open and reliable container runtime
				...
				<div class="stars-today">⭐ 71 stars this week</div>
				</div>
			</div>
      ...
      Free universal database tool and SQL client
				...
				<div class="stars-today">⭐ 660 stars this week</div>
				</div>
			</div>
